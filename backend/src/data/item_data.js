...
export const items = [
  {
    ...
    bidHistory: [
      { bidderId: 'Alex', amount: 850, timestamp: Date.now() - 5000 }
    ]
  },
  {
    id: 2,
    ...
    bidHistory: [
      { bidderId: 'Sarah', amount: 450, timestamp: Date.now() - 10000 }
    ]
  },
  {
    id: 3,
    ...
    bidHistory: [
      { bidderId: 'Marcus', amount: 1200, timestamp: Date.now() - 15000 }
    ]
  },
  {
    id: 4,
    ...
    bidHistory: [
      { bidderId: 'Emma', amount: 1450, timestamp: Date.now() - 8000 }
    ]
  },
  {
    id: 5,
    ...
    bidHistory: [
      { bidderId: 'David', amount: 2850, timestamp: Date.now() - 12000 }
    ]
  },
  {
    id: 6,
    ...
    bidHistory: [
      { bidderId: 'Sophia', amount: 1100, timestamp: Date.now() - 3000 }
    ]
  },
  {
    id: 7,
    ...
    bidHistory: [
      { bidderId: 'James', amount: 3800, timestamp: Date.now() - 20000 }
    ]
  },
  {
    id: 8,
    ...
    bidHistory: [
      { bidderId: 'Nina', amount: 1850, timestamp: Date.now() - 6000 }
    ]
  },
  {
    id: 9,
    ...
    bidHistory: [
      { bidderId: 'Oliver', amount: 4650, timestamp: Date.now() - 25000 }
    ]
  },
  {
    id: 10,
    ...
    bidHistory: [
      { bidderId: 'Isabella', amount: 580, timestamp: Date.now() - 4000 }
    ]
  }
];
